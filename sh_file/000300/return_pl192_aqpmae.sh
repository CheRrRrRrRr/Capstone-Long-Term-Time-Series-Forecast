...
--file_name return_pl192_aqpmae # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=return_pl192_aqpmae # usually same as the following model_id
root_path=./dataset/raw_data # file path
data_path=000300.SH.return.csv # file name
model_id=return_pl192_aqpmae # model name
