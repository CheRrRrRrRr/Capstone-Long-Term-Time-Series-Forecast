...
--file_name close_low_ceemdan_pl192 # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=close_low_ceemdan_pl192 # usually same as the following model_id
root_path=./dataset/ceemdan_close # file path
data_path=000300.SH.close_ceemdan_low.csv # file name
model_id=close_low_ceemdan_pl192 # model name
