...
--file_name close_trend_pl96 # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=close_trend_pl96 # usually same as the following model_id
root_path=./dataset/raw_data # file path
data_path=000300.SH.csv # file name
model_id=close_trend_pl96 # model name
...
pred_len=96 # prediction sequence length, set as the same size as the testing dataset
var_len=20 # variable length. Date not included.
train_val_len=4323 # length of test+val
...
target=next_close # prediction target
