...
--file_name return_IMF1_vmd_pl192 # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=return_IMF1_vmd_pl192 # usually same as the following model_id
root_path=./dataset/VMD/return # file path
data_path=000300.return.train.VMD.IMF1.csv # file name
model_id=return_IMF1_vmd_pl192 # model name
