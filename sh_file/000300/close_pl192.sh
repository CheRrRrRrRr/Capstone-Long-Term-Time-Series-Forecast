...
--file_name 000300_pl192 # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=000300_pl192 # usually same as the following model_id
root_path=./dataset/raw_data # file path
data_path=000300.SH.csv # file name
model_id=000300_pl192 # model name
