...
--file_name return_trend_ceemdan_pl192 # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=return_trend_ceemdan_pl192 # usually same as the following model_id
root_path=./dataset/ceemdan_return # file path
data_path=000300.SH.return_ceemdan_trend.csv # file name
model_id=return_trend_ceemdan_pl192 # model name
