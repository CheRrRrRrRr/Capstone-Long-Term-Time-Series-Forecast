...
--file_name close_IMF3_vmd_pl192 # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=close_IMF3_vmd_pl192 # usually same as the following model_id
root_path=./dataset/VMD/close # file path
data_path=000300.close.train.VMD.IMF3.csv # file name
model_id=close_IMF3_vmd_pl192 # model name
