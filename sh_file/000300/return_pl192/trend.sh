...
--file_name return_close_trend_pl192 # Create a file_name folder in the RESULTS directory
#命名及路径
result_file=return_close_trend_pl192 # usually same as the following model_id
root_path=./dataset/raw_data # file path
data_path=000300.SH.return.csv # file name
model_id=return_close_trend_pl192 # model name
